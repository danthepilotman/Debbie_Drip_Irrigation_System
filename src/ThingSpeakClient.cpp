...
ThingSpeakResponse ThingSpeakClient::getWithRetry(const char* url, uint8_t maxTries, uint32_t delayMs )
{
    ThingSpeakResponse resp;
...
ThingSpeakResponse ThingSpeakClient::postWithRetry( const char* url, const String& body, uint8_t maxTries, uint32_t delayMs )
{
    ThingSpeakResponse resp;
